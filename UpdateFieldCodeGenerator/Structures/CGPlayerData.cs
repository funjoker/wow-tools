...
namespace UpdateFieldCodeGenerator.Structures
{
    ...
    public class CGPlayerData
    {
        ...
        public static readonly UpdateField field_13C = new UpdateField(typeof(int), UpdateFieldFlag.None); // these 2 are both quest ids and are used in condition to trigger PlayerCliQuestGiverAcceptQuest
        public static readonly UpdateField field_140 = new UpdateField(typeof(int), UpdateFieldFlag.None);
